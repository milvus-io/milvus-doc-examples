...
def create_collection():
    client.drop_collection("range_search_collection")
    ...
    client.create_collection(collection_name="range_search_collection",
                             schema=schema,
    ...
    client.insert(collection_name="range_search_collection", data=rows)

    res = client.query(collection_name="range_search_collection",
                       filter="",
                       output_fields=["count(*)"],
